...
request_headers={'User-Agent'		:	'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/535.2 (KHTML, like Gecko) Chrome/15.0.874.121 Safari/535.2'}
...
max_seconds_gen_urls=20

# min records to generate a new urls file
min_records_gen_urls=4000
...
# when archive, gather all info.txt files in a folder instead of letting them stay in the original dir
gather_infotxt=0
